...
# 2. Загрузка документа (PDF, DOCX или веб-страница)
source = "ваш_файл.pdf"  # измените на свой файл или URL
...
# 4. Векторный индекс (FAISS) с мультиязычными эмбеддингами
...
qa_chain = ConversationalRetrievalChain.from_llm(
    ...
    return_source_documents=True,   # для отладки (можно отключить)
    verbose=False
)
