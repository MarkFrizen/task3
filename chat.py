...
# embedding_model_name = "all-MiniLM-L6-v2"                 # маленькая, быстрая, мультиязычная
# embedding_model_name = "paraphrase-multilingual-MiniLM-L12-v2"  # та же, но из кэша
...
embedding_model_name = local_embedding_path  # можно заменить на имя из кэша, как выше
